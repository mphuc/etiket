...
<div id="page_content">
        <div id="page_heading">
            <h1 id="product_edit_name"><?php echo $this->l('form_edit'); ?> <?php echo $table?>
            <?php if(!$this->unset_back_to_list) { ?>
                    <button type="button" class="pull-right md-btn mdn-btn-small return-to-list"><span class="sSwitchIcon"></span> <i class="icon-circle-arrow-left"></i> <?php echo $this->l('list_back'); ?></button>
            <?php } ?> 
            </h1> 
            <span class="uk-text-muted uk-text-upper uk-text-small" id="product_edit_sn"><?php echo $this->l('list_edit_dec'); ?></span>
        </div>
        <div id="page_content_inner">
            <?php
            echo form_open( $update_url, 'method="post" id="crudForm"  autocomplete="off" enctype="multipart/form-data"');
            ?>
                            ...
                            <div class="md-card-content large-padding">
                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        { 
                                            if($input_fields[$field->field_name]->crud_type != "upload_file" && $input_fields[$field->field_name]->crud_type != "datetime" && $input_fields[$field->field_name]->crud_type != "date" && $input_fields[$field->field_name]->crud_type != "enum" && $field->field_name != 'post_parent' && $field->field_name != 'media_gallery') {
                                        ?>
                        ...
                        <div class="md-card">
                            ...
                            <div class="md-card-content">
                                <div id="tampilfitur" class="uk-margin-bottom uk-text-center uk-position-relative">
                                    ...
                                    foreach($fields as $field)
                                     {
                                        if($field->field_name == 'post_parent'){
...
<script type="text/javascript"> 
    $('document').ready(function() {
        ...
        $('#field-post_title').on('keyup',function () {
            ...
            setTimeout(function(){
            if(text.length > 20 && text == $('#field-post_title').val() && text != null && text != "") {
               var status = $("#field-post_status").val();
               if(status == ""){
                $("#field-post_status").val('Draf');
               }
