$(function() {
    altair_form_adv.char_words_counter(), altair_form_adv.rangeSlider(), altair_form_adv.adv_selects(), altair_form_adv.masked_inputs()
}), altair_form_adv = {
                    ...
                    var i = {
                        ...
                        s = {
                            init: function(i) {
                                var a = i.attr("id"),
                                    r = a + "_count";
                                s.isLimitless(), n = t("<span id=" + r + "/>");
                                var o = t("<div/>").attr("id", a + "_counter").append(n).append(" " + s.setMsg());
                                e.container_class && e.container_class.length && o.addClass(e.container_class), e.target && t(e.target).length ? e.append ? t(e.target).append(o) : t(e.target).prepend(o) : e.append ? o.insertAfter(i) : o.insertBefore(i), s.bind(i)
                            },
                            bind: function(t) {
                            ...
                            updateCounter: function(r) {
                                var o = t(this);
                                (0 > a || a > e.goal) && s.passedGoal(o), e.type === i.type ? e.count === i.count ? (a = e.goal - o.val().length, n.text(0 >= a ? "0" : a)) : "up" === e.count && (a = o.val().length, n.text(a)) : "word" === e.type && (e.count === i.count ? (a = s.getWords(o.val()), a <= e.goal ? (a = e.goal - a, n.text(a)) : n.text("0")) : "up" === e.count && (a = s.getWords(o.val()), n.text(a)))
                            },
                            doStopTyping: function(t) {
                                var n = [46, 8, 9, 35, 36, 37, 38, 39, 40, 32];
                                return s.isGoalReached(t) && t.keyCode !== n[0] && t.keyCode !== n[1] && t.keyCode !== n[2] && t.keyCode !== n[3] && t.keyCode !== n[4] && t.keyCode !== n[5] && t.keyCode !== n[6] && t.keyCode !== n[7] && t.keyCode !== n[8] ? e.type === i.type ? !1 : t.keyCode !== n[9] && t.keyCode !== n[1] && e.type != i.type ? !0 : !1 : void 0
                            },
                            ...
                            passedGoal: function(t) {
                                var i = t.val();
                                "word" === e.type && t.val(s.wordStrip(e.goal, i)), "char" === e.type && t.val(i.substring(0, e.goal)), "down" === e.type && n.val("0"), "up" === e.type && n.val(e.goal)
                            }
                        };
