...
}), easing_swiftOut = [.4, 0, .2, 1], bez_easing_swiftOut = jQ.bez(easing_swiftOut);
var $body = $("body"),
    $html = $("html"),
    $document = $(document),
    $window = $(window),
...
altair_page_onload = {
    ...
    search_show: function() {
        jQ(".header_main_content").velocity("transition.slideUpBigOut", {
            duration: 280,
            easing: easing_swiftOut,
            begin: function() {
            ...
            complete: function() {
                jQ(".header_main_search_form").velocity("transition.slideDownBigIn", {
                    duration: 280,
                    easing: easing_swiftOut,
                    complete: function() {
    ...
    search_hide: function() {
        jQ(".header_main_search_form").velocity("transition.slideUpBigOut", {
            duration: 280,
            easing: easing_swiftOut,
            begin: function() {
                jQ("reverse"), $body.removeClass("main_search_active")
            },
            complete: function() {
                jQ(".header_main_content").velocity("transition.slideDownBigIn", {
                    duration: 280,
                    easing: easing_swiftOut,
                    complete: function() {
    ...
    card_expand: function() {
        jQ(".md-expand").velocity("transition.expandIn", {
            stagger: 175,
            drag: !0
        }), jQ(".md-expand-group").children().velocity("transition.expandIn", {
            stagger: 175,
            drag: !0
        })
    },
    ...
    checkbox_radio: function(e) {
        ...
        i.each(function() {
            $(this).next(".iCheck-helper").length || jQ(this).iCheck({
    ...
    fab_speed_dial: function() {
        $(".md-fab-speed-dial").children(".md-fab").append('<i class="material-icons md-fab-action-close" style="display:none">&#xE5CD;</i>').on("click", function() {
            ...
            i.hasClass("md-fab-active") ? i.removeClass("md-fab-active") : i.addClass("md-fab-active"), e.velocity({
                scale: 0
            }, {
                duration: 140,
                easing: easing_swiftOut,
                complete: function() {
                    e.children().toggle(), e.velocity({
                        scale: 1
                    }, {
                        duration: 140,
                        easing: easing_swiftOut
    ...
    custom_scrollbar: function(e) {
        e.wrapInner("<div class='scrollbar-inner'></div>"), Modernizr.touch && e.addClass("touchscroll"), jQ(".scrollbar-inner").scrollbar({
            disableBodyScroll: !0,
            scrollx: !1,
            duration: 100
        })
