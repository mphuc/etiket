...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(base_url()); ?>assets_frontend/images/kemendikbud1.png" sizes="16x16">
    <link rel="icon" type="image/png" href="<?php echo e(base_url()); ?>assets_frontend/images/kemendikbud1.png" sizes="32x32">

    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
    <link rel="stylesheet" href="<?php echo e(base_url()); ?>assets_frontend/css/myStyle.css">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light " style="background-color: #38A7BB;">
      <div class="container">
        <a class="navbar-brand" href="<?php echo e(base_url()); ?>" style="margin-right: 10%;">
            <img src="<?php echo e(base_url()); ?>assets_frontend/images/kemendikbud1.png" style="float: left; margin-right : 5px;" alt="">
          ...
          <form class="form-inline my-2 my-lg-0">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item active" style="padding-right : 20px;">
                <a class="nav-link text-white" href="<?php echo e(base_url()); ?>">Beranda <span class="sr-only">(current)</span></a>
              </li>
              <li class="nav-item" style="padding-right : 30px;">
                <a class="nav-link text-white" href="#" data-toggle="modal" data-target="#syaratKetentuan">Syarat dan Ketentuan</a>
              </li>
              <li class="nav-item" style="padding-right : 30px;">
                <a class="nav-link text-white" href="#" data-toggle="modal" data-target="#kontakKami">Kontak Kami</a>
              </li>
              <li class="nav-item" style="padding-right : 30px;">
                <a class="nav-link text-white" href="#" data-toggle="modal" data-target="#tentangKami">Tentang Kami</a>
              </li>
              <li class="nav-item" style="padding-right : 30px;">
                <a class="nav-link text-white" href="#" data-toggle="modal" data-target="#konfirm">Konfirmasi Pembayaran</a>
              </li>

              <?php if($id_customer == ''): ?>
                  <li class="nav-item">
                    <a class="nav-link text-white" href="#" data-toggle="modal" data-target="#login">Masuk</a>
                  </li>
              <?php else: ?>
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-white" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      Hai, <?php echo e($full_name); ?>

                    </a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                      <a class="dropdown-item" href="#" data-toggle="modal" data-target="#history">History</a>
                      <a class="dropdown-item log-out" href="logout">Logout</a>
                    </div>
                  </li>
              <?php endif; ?>
                          ...
                          <div class="form-group">
                            ...
                            <select name="ticket" id="ticket" class="js-example-basic-single" style="width: 100%" onchange="check_tiket()">
                              ...
                              <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  <option value="<?php echo e($item->product_id); ?>" nama="<?php echo e($item->product_title); ?>" harga="<?php echo e($item->product_price); ?>" product_min="<?php echo e($item->product_min); ?>"><?php echo e($item->product_title); ?></option>
                  ...
                  <div class="col-md-8 col-sm-12 layout-class">
                    <div class="card">
                      <div class="card-header" style="height: 100px;" id="pmb">
                        ...
                        <p style="font-size: 14px;">Dibawah ini adalah tiket yang akan anda pesan, pastikan jumlah dan jenis tiket sesuai dengan rencana kunjungan anda.</p>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="full_name" name="full_name" value="<?php echo e($full_name != '' ? $full_name : ''); ?>" <?php echo e($full_name != '' ? 'readonly' : ''); ?> required>
                          </div>
                          <div class="form-group">
                            <label >Telepon</label>
                            <input type="text" class="form-control" id="telp" name="telp" maxlength="13" onkeypress="return hanyaAngka(event)" value="<?php echo e($phone != '' ? $phone : ''); ?>" <?php echo e($phone != '' ? 'readonly' : ''); ?>>
                          </div>
                          <div class="form-group">
                            <label >Email *</label>
                            <input type="email" placeholder="sebaiknya menggunakan gmail (@gmail.com)." class="form-control" id="email" name="email" value="<?php echo e($email != '' ? $email : ''); ?>" <?php echo e($email != '' ? 'readonly' : ''); ?> required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
                          ...
                          <div class="g-recaptcha" data-sitekey="6Le1RjMfAAAAAGCvWX9i69R8XwKMkcEfQMA0lzaG" style="transform:scale(0.80);-webkit-transform:scale(0.80);transform-origin:0 0;-webkit-transform-origin:0 0;"></div>
                      ...
                      <div class="card-body" style="min-height: 490px">
                        ...
                        <div class="row mt-3">
                          <div class="col-12 ewallet" style="display: none">
                            ...
                            <img src="<?php echo e(base_url()); ?>assets_frontend/images/ovo.png" alt="" style="float: right; width: 30px; margin-right : 10px;">
                          </div>
                        ...
                        <div class="row mt-3">
                          <div class="col-12 VA" style="display: none">
                            ...
                            <img src="<?php echo e(base_url()); ?>assets_frontend/images/bank-mandiri.png" alt="" style="float: right">
                          </div>
                          
                          <div class="col-12 VA" style="display: none">
                            <p style="float: left">Bank BRI</p>
                            <img src="<?php echo e(base_url()); ?>assets_frontend/images/bank-bri.png" alt="" style="float: right; margin-right : 10px;">
                          </div>
                          
                          <div class="col-12 VA" style="display: none">
                            <p style="float: left">Bank BNI</p>
                            <img src="<?php echo e(base_url()); ?>assets_frontend/images/BNI-logo.png" alt="" style="float: right; width: 40px; margin-top : 5px; margin-right : 10px;">
                          </div>
                          
                          <div class="col-12 VA" style="display: none">
                            <p style="float: left">Bank Permata</p>
                            <img src="<?php echo e(base_url()); ?>assets_frontend/images/PermataBank.png" alt="" style="float: right; width: 30px; margin-right : 10px;">
                          </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p style="text-align: justify">
                <?php $__currentLoopData = $tentang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="modal-body">
              <p style="text-align: justify">
                <?php $__currentLoopData = $kontak; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <b><?php echo e($item->tittle); ?></b>
                  <br><?php echo e($item->desc); ?><br><br>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </p>
            </div>
            <div class="modal-footer">
      ...
      <div class="modal fade" id="syaratKetentuan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"">
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <?php $__currentLoopData = $syarat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <b><?php echo e($item->tittle); ?></b>
                <br><?php echo e($item->desc); ?><br><br>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="row" style="margin : 1px;">
                <div class="col-md-5" style="background: url('<?php echo e(base_url()); ?>assets_frontend/images/bg-login3.png'); ">
              ...
              <table class="table table-striped table-bordered" style="width:100%" id="example">
                ...
                <tbody id="history_list">
                  ...
                  <?php $__currentLoopData = $transaction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        <td><?php echo e(date('d-m-Y', strtotime($item->transaction_created))); ?></td>
                        <td>
                          <?php echo e(date('d-m-Y', strtotime($item->transaction_date_used))); ?>   

                          <?php if(date('d', strtotime($item->transaction_date_used)) < date('d') & date('m', strtotime($item->transaction_date_used)) > date('m') ): ?>
                                <button type="button" style="display : inline" id="ubah_jdwl" 
                                  data-toggle="modal" data-id="<?php echo e($item->transaction_id); ?>" 
                                  data-tgl="<?php echo e(date('Y/m/d', strtotime($item->transaction_date_used))); ?>"
                        ...
                        <td>
                          <?php $__currentLoopData = $history; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $x): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($x->transaction_id == $item->transaction_id): ?>
                                  <li><?php echo e($x->product_title); ?> [<?php echo e($x->transaction_detail_qty); ?>]</li> 
                              <?php endif; ?>                             
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </td>
                        <td align="center">
                          <?php if($item->transaction_payment == "ewallet" && $item->transaction_paid != 1): ?>
                            <?php if(date('d', strtotime($item->transaction_date_used)) < date('d') & date('m', strtotime($item->transaction_date_used)) > date('m') ): ?>
                        ...
                        <td>
                          <?php echo e($item->transaction_paid == 0 ? 'Menunggu' : 'Sukses'); ?>

                        </td>
                        <td>
                          <?php echo e(rupiah($item->transaction_total)); ?>
    ...
    <script>
      ...
      $(document).ready(function() {
          ...
          function closed(date){
               ...
               */
                ...
                var disabledDays = <?php echo json_encode($holiday); ?>;

                var sun = <?php echo e($sun); ?>;
                var mon = <?php echo e($mon); ?>;
                var tue = <?php echo e($tue); ?>;
                var wed = <?php echo e($wed); ?>;
                var thu = <?php echo e($thu); ?>;
                var fri = <?php echo e($fri); ?>;
                var sat = <?php echo e($sat); ?>;
          ...
          // $('#history_list').load('<?php echo e(base_url()); ?>getHistory');
      });      
      ...
      function set_total(subTotal = null){
        ...
        if(payment_method == 'ewallet' & total != 0){
          ppn = (total * 0.015) + ((total * 0.015) * 0.11 ); //0,015 = fee xendit , 0,11 ppn 11 %
        }

        else if(payment_method == 'virtual_account' & total != 0){
          ppn = 4500 + (4500 * 0.11); //4500 = fee xendit , 0,11 ppn 11 %
        }

        else if(payment_method == 'qris' & total != 0){
          ppn = (total * 0.007) + ((total * 0.007) * 0.11 ); //0,7 = fee xendit , 0,11 ppn 11 %
        }
      ...
      function reset_pass(){
        ...
        if(email_reset == ''){
          ...
          $.ajax({
            url     : "<?php echo e(base_url()); ?>resetPassword",
            type    : "post",
            data    : {
            ...
            success   : function(x){
              if(x.status != 'failed'){
                ...
                $.ajax({
                  url     : "<?php echo e(base_url()); ?>/sendMailResetPassword/"+x.id,
                  type    : "get",
                });
                ...
                location.replace("<?php echo e(base_url()); ?>"); 
      ...
      function save(nama, telepon, email, date, nama_rombongan, jumlah_rombongan, jenis, paye, ovo){
        $.ajax({
          url     : "<?php echo e(base_url()); ?>/saveTransaction",
          type    : "post",
          data    : {
            // kebutuhan data transaksi
            nama    : nama,
          ...
          success   : function(x){
            ...
            $.ajax({
              url     : "<?php echo e(base_url()); ?>/saveAndSendMail/"+x_id,
              type    : "get",
            }); 
      ...
      function reschedule(){
        ...
        if(tgl == ''){
          ...
          if(!validformat.test(tgl)){
            ...
            // console.log(id, tgl);
            $.ajax({
              url       : '<?php echo e(base_url()); ?>/reschedule',
              type      : 'post',
              data      :{
                id    : id,
                id_dt : id_dt,
              ...
              success   : function(x){
                ...
                if (x.ticket == 'created') {
                  $.ajax({
                  url     : "<?php echo e(base_url()); ?>/resendTicket/"+id,
                    type    : "get",
                  });
                } 
    ...
    $(document).ready(function() {
        if(window.location.href.indexOf('#konfirm') != -1) {
            $('#konfirm').modal('show');
        }
    });
    </script>
...
<?php /**PATH /home/devmusnas/web/dev.tiket.museumnasional.or.id/public_html/application/modules/cms_home/views/index.blade.php ENDPATH**/ ?>