                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-tittle" name="tittle" type="text" value="" maxlength="250" />
                                        </div>
                                                                                                                                                                                                                                                                                                                                
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-telp">Deskripsi</label>
                                            <input class="md-input" id="field-desc" name="desc" type="text" value="" maxlength="200"/>
                                        </div>
