                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-alamat">Tittle <small>(telepon / alamat / email)</small></label>
                                            <input class="md-input" id="field-tittle" name="tittle" type="text" value="{{ $row['tittle'] }}" maxlength="250" />
                                        </div>
                                                                                                                                                                                                                                                                                                                                
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-telp">Deskripsi</label>
                                            <input class="md-input" id="field-desc" name="desc" type="text" value="{{ $row['desc'] }}" maxlength="200"/>
                                        </div>
                                                                                                                                                                                              </div>
                                </div>
                            </div>
