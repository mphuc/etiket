                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-name" name="name" type="text" value="" maxlength="20" />
                                        </div>
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-description">Description</label>
                                            <input class="md-input" id="field-description" name="description" type="text" value="" maxlength="100" />
                                        </div>
                                        <div class="uk-form-row" id="roles_field_box">
                                            <div class="md-input-wrapper md-input-filled">
                                                <select style="width: 100%" id="field-roles" multiple data-md-select2 data-allow-clear="true" data-placeholder="Select roles...">
                                                    @foreach( $roles as $v )
                                                        <option value="{{$v['setting_id']}}">{{$v['setting_name']}}</option>
                                                    @endforeach
                                                </select>
