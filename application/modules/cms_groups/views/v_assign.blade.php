                    ...
                    <div class="uk-width-xLarge-8-10 uk-width-large-7-10" >
                        ...
                        <div class="md-card">
                            <div class="md-card-toolbar">
                                <h3 class="md-card-toolbar-heading-text"> Assign User To Group {{$row['name']}}</h3>
                            </div>
                            <div class="md-card-content large-padding">
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-user">User</label>
                                            <select style="width: 100%" id="field-user" class="uk-width-1-1" data-md-select2 data-allow-clear="true" data-placeholder="User..."></select>
                                        </div>
                                    </div>
                                </div>
                            </div>
