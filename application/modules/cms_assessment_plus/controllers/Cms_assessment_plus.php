 ...
 */
class Cms_assessment_plus extends CI_Controller {
    ...
    public function index()
    {
       try {
            ...
            $umbrella   = $this->base_config->groups_access('assessment_plus');

            $umbrella->set_theme('twitter-bootstrap')
                     ->set_table('tb_assessment_result')
                     ->set_subject('Laporan Penilaian Tambahan')
                     ->where('assessment_result_type','feedplus')
                     ->columns('location_rate_id','assessment_result_name','assessment_result_email','assessment_result_desc','assessment_list_id','assessment_result_value','assessment_date','check_location')
