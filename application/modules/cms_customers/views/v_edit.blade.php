                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-email" name="email" type="text" value="{{ $row['email'] }}" maxlength="250" readonly />
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-full_name">Full Name</label>
                                            <input class="md-input" id="field-full_name" name="full_name" type="text" value="{{ $row['full_name'] }}" maxlength="250" readonly />
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-phone">Phone</label>
                                            <input class="md-input" id="field-phone" name="phone" type="text" value="{{ $row['phone'] }}" maxlength="13" readonly/>
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-addres">Addres</label>
                                            <input class="md-input" id="field-addres" name="addres" type="text" value="{{ $row['addres'] }}" maxlength="250" readonly />
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-date_join">Join</label>
                                            <input class="md-input" id="field-date_join" name="date_join" type="text" value="{{ $row['date_join'] }}" maxlength="250" readonly />
                                        </div>
            ...
            $scope.mySave = function (redirect) {
                ...
                if($('#field-tittle').val() == ''){
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Maaf ...',
                        text: 'Inputan tittle Harus Diisi!'
                    })
                }
                else if($('#field-desc').val() == ''){
                    $('#field-desc').focus();
                    Swal.fire({
                        icon: 'error',
                        title: 'Maaf ...',
                        text: 'Inputan deskripsi Harus Diisi!'
                    })
                }
