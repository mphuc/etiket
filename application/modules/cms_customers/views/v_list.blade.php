...
{{--                                    <button ng-click="readData()" class="md-btn md-btn-primary"><i class="material-icons">loop</i></button>--}}
                                    {{-- <button onclick="location.reload(true)" class="md-btn md-btn-primary"><i class="material-icons">loop</i></button> --}}
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="uk-form-row">
                                <div class="md-input-wrapper">
                                    <select id="search-column" class="md-input">
                                         ...
                                         <option value="phone">No Telephon</option>
                                    </select>
                                </div>
                            </div>
                            <div class="uk-form-row">
                                <div class="uk-grid" data-uk-grid-margin="">
                                    <div class="uk-width-medium-1">
                                        ...
                                        <input class="md-btn md-btn-success uk-modal-close" type="reset" onclick="location.reload(true)" ng-click="reset()" value="Clear filtering">
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="md-card uk-margin-medium-bottom" id="data">
                                    ...
                                    <td>
                                        <div class="uk-button-dropdown" data-uk-dropdown="{mode:'click'}" aria-haspopup="true" aria-expanded="false">
                                            ...
                                            <div class="uk-dropdown uk-dropdown-small uk-dropdown-bottom" style="">
                                                <ul class="uk-nav uk-nav-dropdown">
                                                    <li class="edit-row">
                                                        <a href="{{ base_url("cms/$module/edit") }}/@{{t.id_customer}}" title="Edit"><i class="material-icons">mode_edit</i> Edit</a>
                                                    </li>
                                                    {{-- <li ng-click="deleteClick(t.id_customer)">
