                                    ...
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <select id="field-product_package_id" name="product_package_id" class="md-input" data-md-selectize>
                                                @foreach($disc as $v)
                                                    <option value="{{$v['dp_id']}}">{{$v['dp_name']}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="uk-form-row">
                                            <div class="md-input-wrapper md-input-filled">
                                                <select class="multi-s" id="product_combination_id" multiple>
                                            ...
                                            <span class="uk-form-help-block">Product Combination</span>
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-mp_discount">Discount (%)</label>
                                            <input class="md-input" id="field-mp_discount" name="mp_discount" type="number" value="0" maxlength="3" />
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        app.controller('addController',function($scope, $http)
        {
            ...
            $scope.mySave = function (redirect) {
                ...
                formData['combinations']=$("#product_combination_id").val();;
                $scope.spinner = false;
                $http({
                    url: cms_url+"/add",
                    method: "POST",
