                            ...
                            <div class="uk-form-row">
                                <div class="md-input-wrapper">
                                    <select id="search-column" class="md-input">
                                        ...
                                        <option value="promo_date_start">Promo Date Start</option>
                                        <option value="promo_date_end">Promo Date End</option>
                                        <option value="promo_active">Promo Active</option>
                                    </select>
                                </div>
                            </div>
                            <div class="uk-form-row">
                ...
                <div class="md-card-content">
                    <div class="uk-overflow-container">
                        <table class="uk-table uk-table-nowrap table_check uk-table-striped" style="margin-bottom: 68px;">
                            ...
                            <tr>
                                <th class="small_col">
                                    <input class="check_all" type="checkbox" ng-model="checkbox" ng-click="selectAll($event)" title="Select All">
                                </th>
                                <th>Promo Discount</th>
                                <th>Product</th>
                                <th>Promo Date Start</th>
                                <th>Promo Date End</th>
                                <th>Promo Active</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            ...
                            <tr ng-repeat="t in data">
                                <td><input class="check_row" type="checkbox" ng-checked="checkbox" ng-click="updateSelection($event, t.promo_id)" title="Select"></td>
                                <td>@{{t.promo_discount}}</td>
                                <td>@{{t.product_title}}</td>
                                <td>@{{t.promo_date_start}}</td>
                                <td>@{{t.promo_date_end}}</td>
                                <td ng-if="t.promo_active==1"><span class="uk-badge uk-badge-success">Yes</span></td>
                                <td ng-if="t.promo_active!=1"><span class="uk-badge uk-badge-danger">No</span></td>
                                <td>
                                    <div class="uk-button-dropdown" data-uk-dropdown="{mode:'click'}" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="uk-dropdown uk-dropdown-small uk-dropdown-bottom" style="">
                                            <ul class="uk-nav uk-nav-dropdown">
                                                <li class="edit-row">
                                                    <a href="{{ base_url("cms/$module/edit") }}/@{{t.promo_id}}" title="Edit"><i class="material-icons">mode_edit</i> Edit</a>
                                                </li>
                                                <li ng-click="deleteClick(t.promo_id)">
        ...
        app.controller('listController',function($scope, $http)
        {
            ...
            $scope.selectAll = function($event) {
                ...
                for ( var i = 0; i < $scope.data.length; i++) {
                    ...
                    updateSelected(action, entity.promo_id);
                }
            };
