    ...
    <div id="page_content" ng-controller="editController">
        ...
        <div id="page_content_inner" style="display: none;">
            <form id="form" action="" method="post" class="form-div uk-form-stacked" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="return false;">
                <input type="hidden" name="promo_id" value="{{ $row[$pk] }}">
                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-promo_discount" name="promo_discount" type="number" value="{{$row["promo_discount"]}}" maxlength="3" />
                                        </div>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-promo_active">Promo Active</label>
                                            <p id="field-promo_active">
                                                <input type="radio" name="promo_active" value="1" id="field-promo_active-1" data-md-icheck @if($row["promo_active"]==1) checked @endif >
                                                <label for="field-promo_active-1" class="inline-label">Yes</label>
                                                <input type="radio" name="promo_active" value="0" id="field-promo_active-2" data-md-icheck @if($row["promo_active"]!=1) checked @endif >
                    ...
                    <div class="uk-width-xLarge-2-10 uk-width-large-3-10 uk-sortable sortable-handler" data-uk-grid-margin data-uk-sortable>
                            ...
                            <div class="md-card-content">
                                ...
                                <div class="uk-form-row">
                                    ...
                                    <input class="datepic" id="field-promo_date_start" name="promo_date_start" type="text" value="{{$row["promo_date_start"]}}" >
                                </div><br>
                                                                                                                                                                                                                                                                                                            
                                <div class="uk-form-row">
                                    <label class="uk-form-label" for="field-promo_date_end">Promo Date End</label>
                                    <input class="datepic" id="field-promo_date_end" name="promo_date_end" type="text" value="{{$row["promo_date_end"]}}" >
                                </div><br>
