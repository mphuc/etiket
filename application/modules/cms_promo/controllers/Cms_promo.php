 ...
 */
class Cms_promo extends MX_Controller
{
    protected $table = 'tb_promo';
    protected $subject = 'Data promo';
    protected $module;
    ...
    public function get()
    {
        ...
        if( isset($search) && $column ){
            $this->db->like("tb_promo.$column", $search);
        }
        $this->db->join('tb_product','tb_product.product_id=tb_promo.product_id');
        $this->db->order_by('promo_date_end', 'desc');
