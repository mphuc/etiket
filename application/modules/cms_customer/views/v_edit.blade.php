                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-nama" name="nama" type="text" value="{{$row["nama"]}}" maxlength="200" >
                                        </div>
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-gender">Gender</label >
                                            <p id="field-gender">
                                                <input type="radio" name="gender" value="L" id="field-gender-1" data-md-icheck @if($row["gender"]=='L') checked @endif/>
                                                <label for="field-gender-1" class="inline-label">LAKI-LAKI</label>&nbsp;&nbsp;
                                                <input type="radio" name="gender" value="P" id="field-gender-2" data-md-icheck @if($row["gender"]=='P') checked @endif/>
                                                <label for="field-gender-2" class="inline-label">PEREMPUAN</label>
                                            </p>
                                        </div>
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-phone">Phone</label>
                                            <input class="md-input" id="field-phone" name="phone" type="text" value="{{$row["phone"]}}" maxlength="20" >
                                        </div>
                                        <div class="uk-form-row">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-address" name="address" type="text" value="{{$row["address"]}}" maxlength="255" >
                                        </div>
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-email">Email</label>
                                            <input class="md-input" id="field-email" name="email" type="text" value="{{$row["email"]}}" maxlength="50" >
                                        </div>
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-facebook">Facebook</label>
                                            <input class="md-input" id="field-facebook" name="facebook" type="text" value="{{$row["facebook"]}}" maxlength="100" >
                                        </div>
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-twitter">Twitter</label>
                                            <input class="md-input" id="field-twitter" name="twitter" type="text" value="{{$row["twitter"]}}" maxlength="100" >
                                        </div>
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-instagram">Instagram</label>
                                            <input class="md-input" id="field-instagram" name="instagram" type="text" value="{{$row["instagram"]}}" maxlength="100" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="md-card">
                            ...
                            <div class="md-card-content">
                                <div class="uk-form-row">
                                    ...
                                    <input class="datepic" id="field-birthday" name="birthday" type="text" value="{{$row["birthday"]}}" >
                                </div><br>
                            </div>
                            <div class="md-card-toolbar">
                                <h3 class="md-card-toolbar-heading-text"><br></h3>
