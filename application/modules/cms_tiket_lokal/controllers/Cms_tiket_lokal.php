 ...
 * @property    Setting Setting
 */
class Cms_tiket_lokal extends MX_Controller
{
    protected $table = '';
    protected $subject = '';
    protected $module;
    ...
    public function verifyQris(){
        $this->XenditModel->verify_qris();
    }

    public function verifyQrisCallback(){
        $this->XenditModel->verify_qris_callback();
    }
