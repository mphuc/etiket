<link rel="stylesheet" href="<?php echo $asset; ?>css/error_page.min.css" />
<link rel="stylesheet" href="<?php echo $asset; ?>css/404/robot_page.css" />
<link rel="stylesheet" href="<?php echo $asset; ?>css/404/robot_styles.css" />
<script>
    var isHeadless = true;
</script>
<body>
        ...
        <div class="robotpage-bottom-half">
            ...
            <div>
                <p id="robot-text">Page Not Found</p>
                 The requested URL <span class="uk-text-muted"></span> was not found on this server or <b>You do not have permissions to view this page</
                <div class="robot-buttons">
                    <a class="robot-buttons" onclick="history.go(-1);return false;">Back</a> 
                </div><br>
                <a href="cms" class="sSidebar_hide"><img width="100" height="42" src="img/load/510/215/png2/{logo}" alt="" /></a>
            </div>
...
<script src="<?php echo $asset; ?>css/404/TweenMax.min.js"></script>
<script src="<?php echo $asset; ?>css/404/brokebot.js"></script>
<script src="<?php echo $asset; ?>css/404/snap.svg-min.js"></script>
</body>
</html>