    ...
    <div id="page_content" ng-controller="editController">
        ...
        <div id="page_content_inner" style="display: none;">
            <form id="form" action="" method="post" class="form-div uk-form-stacked" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="return false;">
                <input type="hidden" name="dp_id" value="{{ $row[$pk] }}">
                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-dp_name">Dp Name</label>
                                            <input class="md-input" id="field-dp_name" name="dp_name" type="text" value="{{$row["dp_name"]}}" maxlength="255" >
                                        </div>
                                                                                                                                                                                                                                                                                                                                                                                    
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-dp_description">Dp Description</label>
                                            <input class="md-input" id="field-dp_description" name="dp_description" type="text" value="{{$row["dp_description"]}}" maxlength="255" >
                                        </div>
                                                                                                                                                                                                                                                                                    </div>
                                </div>
                            </div>
