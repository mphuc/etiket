...
@section('body')
 ...
 <option value="dp_name">Dp Name</option>                                                                                  
 <option value="dp_description">Dp Description</option>                                                                             </select>
                                </div>
                            </div>
                            <div class="uk-form-row">
                                <div class="uk-grid" data-uk-grid-margin="">
            ...
            <div class="uk-modal" id="modal-detail" aria-hidden="true">
                <div class="uk-modal-dialog" style="top: -15.5px;">
                    <div class="uk-modal-header">
                        <div class="uk-clearfix">
                            <div class="uk-float-left">
                                <h3 class="uk-modal-title">Detail - @{{ discount.dp_name }}</h3>
                            </div>
                            <div class="uk-float-right">
                                <a class="md-btn md-btn-flat md-btn-wave waves-effect waves-button uk-modal-close" href="javascript:void(0)"><i class="material-icons">close</i></a>
                            </div>
                    ...
                    <div class="uk-overflow-container">
                        <table class="uk-table uk-table-nowrap table_check uk-table-striped" style="margin-bottom: 68px;">
                            ...
                            <tr ng-repeat="t in data">
                                <td><input class="check_row" type="checkbox" name="checkbox_t.dp_id" ng-checked="checkbox" ng-click="updateSelection($event, t.dp_id)" title="Select"></td>
                                <td>@{{t.dp_name}}</td>
                                <td>@{{t.dp_description}}</td>
                                <td><button ng-click="readDetails(t.dp_id)" data-uk-modal="{target:'#modal-detail'}" class="md-btn mdn-btn-small md-btn-success">SHOW DETAIL</button></td>
                                <td>
                                    <div class="uk-button-dropdown" data-uk-dropdown="{mode:'click'}" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="uk-dropdown uk-dropdown-small uk-dropdown-bottom" style="">
                                            <ul class="uk-nav uk-nav-dropdown">
                                                <li class="edit-row">
                                                    <a href="{{ base_url("cms/$module/edit") }}/@{{t.dp_id}}" title="Edit"><i class="material-icons">mode_edit</i> Edit</a>
                                                </li>
                                                <li ng-click="deleteClick(t.dp_id)">
        ...
        app.controller('listController',function($scope, $http)
        {
            ...
            $scope.readDetails = function (id) {
                angular.forEach($scope.data, function(value, key) {
                    if( id === value.dp_id ) $scope.discount = value;
                });
                $http({
                    method: 'GET',
            ...
            $scope.selectAll = function($event) {
                ...
                for ( var i = 0; i < $scope.data.length; i++) {
                    ...
                    updateSelected(action, entity.dp_id);
                }
            };
