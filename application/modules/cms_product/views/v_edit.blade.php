    ...
    <div id="page_content" ng-controller="editController">
        ...
        <div id="page_content_inner" style="display: none;">
            <form id="form" action="" method="post" class="form-div uk-form-stacked" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="return false;">
                <input type="hidden" name="product_id" value="{{ $row[$pk] }}">
                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-product_title" name="product_title" type="text" value="{{$row["product_title"]}}" maxlength="255" >
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-product_desc">Description</label>
                                            <textarea class="md-input" id="field-product_desc" name="product_desc" maxlength="product_desc">{{$row["product_desc"]}}</textarea>
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-product_price">Price</label>
                                            <input class="md-input numeric" id="field-product_price" name="product_price" type="text" value="{{$row["product_price"]}}" autocomplete="off"/>
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-product_min">Min (Min.Buy)</label>
                                            <input class="md-input" id="field-product_min" name="product_min" type="number" value="{{$row["product_min"]}}" min="1" autocomplete="off"/>
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-product_stock">Stock</label>
                                            <input class="md-input" id="field-product_stock" name="product_stock" type="number" value="{{$row["product_stock"]}}" min="1" autocomplete="off"/>
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-product_active">Product Active</label>
                                            <p id="field-product_active">
                                                <input type="radio" name="product_active" value="1" id="field-product_active-1" data-md-icheck @if($row["product_active"]==1) checked @endif >
                                                <label for="field-product_active-1" class="inline-label">Yes</label>
                                                <input type="radio" name="product_active" value="0" id="field-product_active-2" data-md-icheck @if($row["product_active"]!=1) checked @endif >
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <p id="field-is_ticket">
                                                <input type="radio" name="is_ticket" value="1" id="field-is_ticket-1" data-md-icheck @if($row["is_ticket"]==1) checked @endif >
                                                <label for="field-is_ticket-1" class="inline-label">Yes</label>
                                                <input type="radio" name="is_ticket" value="0" id="field-is_ticket-2" data-md-icheck @if($row["is_ticket"]!=1) checked @endif >
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <p id="field-gate_name">
                                                @foreach($gate as $k => $v)
                                                    <input type="radio" name="gate_name" value="{{$v['gate_name']}}" id="field-gate_name-{{$k}}" data-md-icheck @if($row["gate_name"]==$v['gate_name']) checked @endif>
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-product_code" name="product_code" type="text" value="{{$row["product_code"]}}" autocomplete="off"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="uk-width-xLarge-2-10 uk-width-large-3-10 uk-sortable sortable-handler" data-uk-grid-margin data-uk-sortable>
                            ...
                            <div class="md-card-content">
                                <div class="uk-form-row">
                                    ...
                                    <input id="product_order" name="product_order" value="{{$row['product_order']}}" class="md-input" required>
                                </div>
                                <div class="uk-form-row">
                                    <label for="category">Category</label>
                                    <select id="category" name="category_id" class="md-input" data-md-selectize>
                                        @foreach($categories as $v)
                                            <option value="{{$v['category_id']}}" @if($v['category_id']==$row['category_id']) selected @endif>{{$v['category_name']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <br>
