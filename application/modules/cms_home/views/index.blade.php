...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light " style="background-color: #38A7BB;">
      <div class="container">
        <a class="navbar-brand" href="{{ base_url() }}" style="margin-right: 10%;">
    ...
    {{-- <a href="{{ base_url() }}testTicket" target="blank">test</a> --}}
                    ...
                    <form action="">
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <label >Email *</label>
                            <input type="email" placeholder="sebaiknya menggunakan gmail (@gmail.com)." class="form-control" id="email" name="email" value="{{ $email != '' ? $email : '' }}" {{ $email != '' ? 'readonly' : '' }} required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group">
    ...
    <script>
      ...
      $(document).ready(function() {
          ...
          // $('#history_list').load('{{ base_url() }}getHistory');
      });      
          ...
          $.ajax({
            ...
            success   : function(x){
              if(x.status != 'failed'){
                ...
                $.ajax({
                  url     : "{{ base_url() }}/sendMailResetPassword/"+x.id,
                  type    : "get",
                });
