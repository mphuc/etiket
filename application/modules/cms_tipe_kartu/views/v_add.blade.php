                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-card_type_name" name="card_type_name" type="text" value="" maxlength="255" />
                                        </div>
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-card_type_order">Order</label>
                                            <input class="md-input" id="field-card_type_order" name="card_type_order" type="number" value="1" />
                                        </div>
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-bank_order">Payee</label>
                                            <select class="md-input" name="id_payee" id="id_payee" style="margin-top: 20px;">
                                                <option value="">-- Type Card --</option>
                                                @foreach ($payee as $item)
                                                    <option value="{{ $item->payee_id }}" nama="{{ $item->payee_name }}">{{ $item->payee_name }}</option>
                                                @endforeach
                                            </select>                                            
                                        </div>
                                                                                                                                                                                                                                                                                    </div>
