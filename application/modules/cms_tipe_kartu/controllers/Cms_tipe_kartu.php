 ...
 */
class Cms_tipe_kartu extends MX_Controller
{
    protected $table = 'tb_card_type';
    protected $subject = 'Data Tipe Kartu';
    protected $module;
    protected $primary_key = 'card_type_id';
    ...
    public function add()
    {
        ...
        $data['module'] = $this->module;
        $data['pk'] = $this->primary_key;
        $data['payee'] = $this->db->get('tb_payee')->result();
    ...
    public function get()
    {
        ...
        $this->db->join('tb_payee', 'tb_card_type.id_payee = tb_payee.payee_id', 'left');
        $this->db->order_by('card_type_order','asc');
