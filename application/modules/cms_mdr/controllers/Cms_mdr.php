 ...
 */
class Cms_mdr extends MX_Controller
{
    protected $table = 'tb_mdr';
    protected $subject = 'Data MDR';
    protected $module;
    protected $primary_key = 'mdr_id';
    ...
    public function add()
    {
        ...
        $data['module'] = $this->module;
        $data['pk'] = $this->primary_key;
        $data['bank'] = $this->userModel->getBank2();
        $data['type_card'] = $this->db->get('tb_card_type')->result();
