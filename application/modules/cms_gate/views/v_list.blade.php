...
@section('body')
 ...
 <option value="gate_name">Gate Name</option>                                                                                  
 <option value="gate_desc">Gate Desc</option>                                                                             </select>
                                </div>
                            </div>
                            <div class="uk-form-row">
                                <div class="uk-grid" data-uk-grid-margin="">
 ...
 <td><input class="check_row" type="checkbox" name="checkbox_t.gate_id" ng-checked="checkbox" ng-click="updateSelection($event, t.gate_id)" title="Select"></td>
                                        ...
                                        <td>
                                            <div class="uk-button-dropdown" data-uk-dropdown="{mode:'click'}" aria-haspopup="true" aria-expanded="false">
                                                ...
                                                <div class="uk-dropdown uk-dropdown-small uk-dropdown-bottom" style="">
                                                    <ul class="uk-nav uk-nav-dropdown">
                                                        <li class="edit-row">
                                                            <a href="{{ base_url("cms/$module/edit") }}/@{{t.gate_id}}" title="Edit"><i class="material-icons">mode_edit</i> Edit</a>
                                                        </li>
                                                        <li ng-click="deleteClick(t.gate_id)">
        ...
        app.controller('listController',function($scope, $http)
        {
            ...
            $scope.selectAll = function($event) {
                ...
                for ( var i = 0; i < $scope.data.length; i++) {
                    ...
                    updateSelected(action, entity.gate_id);
                }
            };
