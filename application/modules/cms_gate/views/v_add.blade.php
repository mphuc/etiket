                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-gate_name" name="gate_name" type="text" value="" maxlength="100" />
                                        </div>
                                                                                                                                                                                                                                                                                                                                                                        
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-gate_desc">Gate Desc</label>
                                            <input class="md-input" id="field-gate_desc" name="gate_desc" type="text" value="" maxlength="255" />
                                        </div>
                                                                                                                                                                                                                                                                                    </div>
                                </div>
                            </div>
