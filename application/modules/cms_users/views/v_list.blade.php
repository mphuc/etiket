                            ...
                            <div class="uk-form-row">
                                <div class="md-input-wrapper">
                                    <select id="search-column" class="md-input">
                                         ...
                                         <option value="user_mobile">User Mobile</option>
                                         <option value="user_display_name">User Display Name</option>
                                    </select>
                                </div>
                            </div>
                            <div class="uk-form-row">
                    ...
                    <div class="uk-overflow-container">
                        <table class="uk-table uk-table-nowrap table_check uk-table-striped" style="margin-bottom: 68px;">
                            ...
                            <tr ng-repeat="t in data">
                                <td>
                                    <img onerror="this.src='{{link_upload('avatar.png')}}'" ng-src="{{base_url('assets/uploads')}}/@{{t.user_avatar}}" style="max-width: 64px">
                                </td>
                                <td>
                                    <b>@{{t.username}}</b><br>
                                    @{{t.email}}
                                </td>
                                <td>@{{t.user_display_name}}</td>
                                <td>
                                    <p ng-repeat="g in t.groups">@{{ g.group_name }}</p>
                                </td>
                                <td>
                                <small ng-if="t.active==1"><span class="uk-badge uk-badge-success">Active</span></small>
                                <small ng-if="t.active!=1"><span class="uk-badge uk-badge-danger">Not Active</span></small><br>
                                    <span title="@{{t.last_login | moment: 'format': 'LLL'}}" class="uk-badge uk-badge-primary">Last Login @{{t.last_login | moment: 'format': 'LLL'}}</span>
                                </td>
                                <td>
...
@section('script')
    <script type="text/javascript">
        ...
        app.controller('listController',function($scope, $http)
        {
            ...
            $scope.readData = function(limit,page) {
            ...
            $scope.searchClick = function () {
                ...
                $scope.pageStart = 1;
                $scope.readData($scope.perPage, $scope.pageStart);
            };
