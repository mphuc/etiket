                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-category_name">Category Name</label>
                                            <input class="md-input" id="field-category_name" name="category_name" type="text" value="" maxlength="200" />
                                        </div>
                                                                                                                                                                                                                                                                                                                                                                                                                                                        
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="category_desc">Category Desc</label>
                                            <textarea id="category_desc" name="category_desc" class="md-input"></textarea>
                                        </div>

                                        <input id="field-category_parent" name="category_parent" type="hidden" value="0" maxlength="11" />
                                        <input id="field-category_type" name="category_type" type="hidden" value="product" maxlength="50" />

                                        <br>
                                                                                                                                                                                                                                                                                                                                                                        
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-category_order">Category Order</label>
                                            <input class="md-input" id="field-category_order" name="category_order" type="number" value="{{$max_order+1}}" maxlength="11" />
                                        </div>
                                                                                                                                                                                                                                            </div>
                                </div>
                            </div>
