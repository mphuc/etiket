    ...
    <div id="page_content" ng-controller="editController">
        ...
        <div id="page_content_inner" style="display: none;">
            <form id="form" action="" method="post" class="form-div uk-form-stacked" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="return false;">
                <input type="hidden" name="category_id" value="{{ $row[$pk] }}">
                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-category_name" name="category_name" type="text" value="{{$row["category_name"]}}" maxlength="200" >
                                        </div>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-category_desc">Category Desc</label>
                                            <textarea class="md-input" id="field-category_desc" name="category_desc" maxlength="category_desc">{{$row["category_desc"]}}</textarea>
                                        </div>
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-category_order" name="category_order" type="number" value="{{$row["category_order"]}}" maxlength="11" />
                                        </div>
                                                                                                                                                                                                                                            </div>
                                </div>
                            </div>
