 ...
 */
class Cms_category_product extends MX_Controller
{
    protected $table = 'tb_category';
    protected $subject = 'Data category_product';
    protected $module;
    ...
    public function add()
    {
        ...
        if( $_POST ){
            ...
            $_POST['category_slug'] = $this->slug->create_uri($_POST['category_name']);
        ...
        $data['module'] = $this->module;
        $data['pk'] = $this->primary_key;
        $data['max_order'] = $this->db->where('category_type','product')->count_all_results($this->table);
