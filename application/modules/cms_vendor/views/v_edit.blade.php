    ...
    <div id="page_content" ng-controller="editController">
        ...
        <div id="page_content_inner" style="display: none;">
            <form id="form" action="" method="post" class="form-div uk-form-stacked" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="return false;">
                <input type="hidden" name="vendor_id" value="{{ $row[$pk] }}">
                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-vendor_name">Vendor Name</label>
                                            <input class="md-input" id="field-vendor_name" name="vendor_name" type="text" value="{{$row["vendor_name"]}}" maxlength="255" >
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-vendor_description">Vendor Description</label>
                                            <input class="md-input" id="field-vendor_description" name="vendor_description" type="text" value="{{$row["vendor_description"]}}" maxlength="255" >
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-vendor_order">Vendor Order</label>
                                            <input class="md-input" id="field-vendor_order" name="vendor_order" type="number" value="{{$row["vendor_order"]}}" maxlength="255" />
                                        </div>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </div>
                                </div>
                            </div>
