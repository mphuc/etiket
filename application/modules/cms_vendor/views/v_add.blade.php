                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-vendor_name" name="vendor_name" type="text" value="" maxlength="255" />
                                        </div>
                                                                                                                                                                                                                                                                                                                                                                        
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-vendor_description">Vendor Description</label>
                                            <input class="md-input" id="field-vendor_description" name="vendor_description" type="text" value="" maxlength="255" />
                                        </div>

                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-vendor_order">Vendor Order</label>
                                            <input class="md-input" id="field-vendor_order" name="vendor_order" type="number" value="1" maxlength="255" />
                                        </div>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            </div>
                                </div>
                            </div>
