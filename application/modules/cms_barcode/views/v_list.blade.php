                            ...
                            <div class="uk-form-row">
                                <div class="md-input-wrapper">
                                    <select id="search-column" class="md-input">
                                        <option value="ub_barcode">Barcode</option>
                    ...
                    <div class="uk-overflow-container">
                        <table class="uk-table uk-table-nowrap table_check uk-table-striped" style="margin-bottom: 68px;">
                            ...
                            <tr ng-repeat="t in data">
                                <td><input class="check_row" type="checkbox" name="checkbox_t.ub_id" ng-checked="checkbox" ng-click="updateSelection($event, t.ub_id)" title="Select"></td>
                                <td>@{{t.ub_barcode}}</td>
                                <td ng-if="t.ub_active==1"><span class="uk-badge uk-badge-success">Yes</span></td>
                                <td ng-if="t.ub_active!=1"><span class="uk-badge uk-badge-danger">No</span></td>
                                <td>@{{t.username}}</td>
                                <td>
                                    <div class="uk-button-dropdown" data-uk-dropdown="{mode:'click'}" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="uk-dropdown uk-dropdown-small uk-dropdown-bottom" style="">
                                            <ul class="uk-nav uk-nav-dropdown">
                                                <li class="edit-row">
                                                    <a href="{{ base_url("cms/$module/edit") }}/@{{t.ub_id}}" title="Edit"><i class="material-icons">mode_edit</i> Edit</a>
                                                </li>
                                                <li ng-click="deleteClick(t.ub_id)">
        ...
        app.controller('listController',function($scope, $http)
        {
            ...
            $scope.selectAll = function($event) {
                ...
                for ( var i = 0; i < $scope.data.length; i++) {
                    ...
                    updateSelected(action, entity.ub_id);
                }
            };
