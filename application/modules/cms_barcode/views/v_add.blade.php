                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-ub_barcode">Barcode</label>
                                            <input class="md-input" id="field-ub_barcode" name="ub_barcode" type="text" value="{{$barcode}}" maxlength="10" />
                                        </div>
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-ub_active">Active</label >
                                            <p id="field-ub_active">
                                                <input type="radio" name="ub_active" value="1" id="field-ub_active-1" data-md-icheck checked/>
                                                <label for="field-ub_active-1" class="inline-label">Yes</label>
                                                <input type="radio" name="ub_active" value="0" id="field-ub_active-2" data-md-icheck />
                                                <label for="field-ub_active-2" class="inline-label">No</label>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="md-card">
                            ...
                            <div class="md-card-content">
                                <div class="uk-form-row">
                                    ...
                                    <select id="user_id" name="user_id" class="md-input" data-md-selectize>
                                        @foreach($users as $v)
                                            @if( !in_array($v['id'],$user_id_exist) ) <option value="{{$v['id']}}">{{$v['username']}}</option> @endif
                                        @endforeach
                                    </select>
                                </div>
                            </div>
