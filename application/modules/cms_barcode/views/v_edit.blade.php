    ...
    <div id="page_content" ng-controller="editController">
        ...
        <div id="page_content_inner" style="display: none;">
            <form id="form" action="" method="post" class="form-div uk-form-stacked" enctype="multipart/form-data" accept-charset="utf-8" onsubmit="return false;">
                <input type="hidden" name="ub_id" value="{{ $row[$pk] }}">
                                ...
                                <div class="uk-grid uk-grid-divider uk-grid-medium" data-uk-grid-margin>
                                    <div class="uk-width-large-1">
                                        ...
                                        <div class="uk-form-row">
                                            ...
                                            <input class="md-input" id="field-ub_barcode" name="ub_barcode" type="text" value="{{$row["ub_barcode"]}}" maxlength="50" >
                                        </div>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
                                        <div class="uk-form-row">
                                            <label class="uk-form-label" for="field-ub_active">Active</label>
                                            <p id="field-ub_active">
                                                <input type="radio" name="ub_active" value="1" id="field-ub_active-1" data-md-icheck @if($row["ub_active"]==1) checked @endif >
                                                <label for="field-ub_active-1" class="inline-label">Yes</label>
                                                <input type="radio" name="ub_active" value="0" id="field-ub_active-2" data-md-icheck @if($row["ub_active"]!=1) checked @endif >
