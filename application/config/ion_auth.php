...
*
*/
$email_config = get_instance()->db->where('setting_type', 'setting_email')->get('tb_setting')->result_array();
foreach ($email_config as $item => $value) {
    $email[$value['setting_desc']] = $value['setting_value'];
}
$email['newline']                     = "\r\n";
 ...
 */
$config['site_title']                 = $email['smtp_name']; // Site Title, example.com
$config['admin_email']                = $email['smtp_user']; // Admin Email, admin@example.com
$config['default_group']              = 'loket';           // Default group, use name
