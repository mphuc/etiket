...
<head>
    ...
    <link rel="icon" type="image/png" href="themes/umbrella-back/2ndmaterial/img/favicon-16x16.png" sizes="16x16">
    <link rel="icon" type="image/png" href="themes/umbrella-back/2ndmaterial/img/favicon-32x32.png" sizes="32x32">
    <title>Cpanel | Umbrella V.2 Second Vision Corp</title>
    <link href='https://fonts.googleapis.com/css?family=Roboto:300,400,500' rel='stylesheet' type='text/css'>
    <link rel="stylesheet" href="themes/umbrella-back/2ndmaterial/bower_components/uikit/css/uikit.almost-flat.min.css"/>
        <!-- flag icons -->
        <link rel="stylesheet" href="themes/umbrella-back/2ndmaterial/icons/flags/flags.min.css" media="all">
    <!-- altair admin -->
    <link rel="stylesheet" href="themes/umbrella-back/2ndmaterial/css/main.min.css" media="all">
    <link rel="stylesheet" href="themes/umbrella-back/2ndmaterial/css/custom.css" media="all">
</head>

<body class="sidebar_main_open sidebar_main_swipe"><link rel="stylesheet" href="themes/umbrella-back/2ndmaterial/css/error_page.min.css" />
<link rel="stylesheet" href="themes/umbrella-back/2ndmaterial/css/404/robot_page.css" />
<link rel="stylesheet" href="themes/umbrella-back/2ndmaterial/css/404/robot_styles.css" />
<script>
    var isHeadless = true;
</script>
<body>
    <div>
        ...
        <div class="robotpage-bottom-half">
            ...
            <div>
                <p id="robot-text"><?php echo $heading; ?></p>
                <?php echo $message; ?>
                <div class="robot-buttons">
                    <a class="robot-buttons" onclick="history.go(-1);return false;">Back</a> 
                </div><br>
                <a href="cpanel" class="sSidebar_hide"><img width="100" height="42" src="img/load/510/215/png2/panellogo.png" alt="" /></a>
            </div>
...
<script src="themes/umbrella-back/2ndmaterial/css/404/TweenMax.min.js"></script>
<script src="themes/umbrella-back/2ndmaterial/css/404/brokebot.js"></script>
<script src="themes/umbrella-back/2ndmaterial/css/404/snap.svg-min.js"></script>
</body>
</html>