...
<div class="container" style="width: 480px; text-align: center; border-top-color: #1c7a8a; padding: 10px; border-style: solid dashed dashed; border-width: 5px 1px 1px; @media (max-width:768px){width: 99%;} " align="center">
    ...
    <section class="box-kode" style="text-align: center;">
        <table align="center">
            <tr>
                <td class="">
                    <img width="100%" src="{logo_tamanpintar}" alt="logo taman pintar">
                </td>
            </tr>
            <tr>
                <td class="">Kode Pemesanan Tiket :</td>
            </tr>
            <tr>
    ...
    <section style="text-align: center;">
        <h4 style="margin-bottom: 5px; font-weight: 100;">Detail Pembayaran :</h4>
        <table align="center" class="norek" width="250px" style="border-collapse: collapse; padding: 5px; border: 1px solid;">
            <tr>
                <td style="border-collapse: collapse; padding: 5px; border: 1px solid;">Kode Transaksi : {kp_kode_transaksi}</td>
            </tr>
            <tr>
                <td style="border-collapse: collapse; padding: 5px; border: 1px solid;">A/N : {kp_atas_nama}</td>
            </tr>
            <tr>
                <td style="border-collapse: collapse; padding: 5px; border: 1px solid;">Nominal Transfer(Rp) : {kp_jumlah2}</td>
            </tr>
            <tr>
                <td style="border-collapse: collapse; padding: 5px; border: 1px solid;">Nama Bank : {kp_nama_bank}</td>
            </tr>
        </table>
    </section>
    ...
    <section style="text-align: center;">
        ...
        <table align="center" class="detail" width="100%">
            ...
            <?php endif;?>
            <tr>
                <td colspan="4" align="right" style="border-collapse: collapse; padding: 5px; border: 0;"><b>Total Yang Sudah dibayar</b></td>
                <td style="border-collapse: collapse; padding: 5px; border: 0;">
