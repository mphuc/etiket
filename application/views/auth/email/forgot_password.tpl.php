...
<body yahoo="fix" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<table border="0" width="100%" cellpadding="0" cellspacing="0" bgcolor="2b2e34" style="background-image: url(http://visitingjogja.com/assets/uploads/316_desawisatatanjung.jpg); background-size: 100% 100%; background-position: top center;" background="http://themastermail.com/alerta/notif5/img/bg.png">
		...
		<tr>
			<td>
				<table border="0" align="center" width="510" cellpadding="0" cellspacing="0" bgcolor="ffffff" class="container590 bodybg_color" style="border-radius: 4px;">
					...
					<tr>
						<td align="center">
							<a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="110" border="0" style="display: block; width:110px;" src="<?php echo base_url('themes/umbrella-front/default/img/kidsfun.JPG')?>" alt="logo" /></a>
						</td>			
					</tr>
								...
								<tr>
									<td align="center" style="color: #8d94a3; font-size: 16px; font-family: 'Oxygen', sans-serif; mso-line-height-rule: exactly; line-height: 24px;" class="resize-text text_color">
										<div style="line-height: 24px">
				        						Permintaan password baru untuk kontributor dengan email <?php echo  $identity; ?>, Permintaan password anda hampir berhasil, untuk dapat melakukan perubahan password baru anda cukup klik link di bawah ini :
										</div>
			        				</td>	
								</tr>
							</table>
							...
							<table border="0" align="center" width="300" cellpadding="0" cellspacing="0" bgcolor="2dabcb" style="border-radius: 50px; box-shadow: 0 2px 0 2px #239bb9;" class="cta-button main_color">
								...
								<tr>
	                				<td align="center" style="color: #ffffff; font-size: 18px; font-family: 'Questrial', sans-serif;" class="cta-text">
		                    			<div style="line-height: 24px;">
			                    			<a href="<?php echo base_url("cms/auth/reset_password?code=$forgotten_password_code") ?>" style="color: #ffffff; text-decoration: none;">Ganti Password</a>
		                    			</div>
		                    		</td>
	                			</tr>
								<tr><td height="17" style="font-size: 17px; line-height: 17px;">&nbsp;</td></tr>
					...
					<tr>
						<td align="center" style="color: #8d94a3; font-size: 14px; font-family: 'Questrial', sans-serif; line-height: 22px;" class="text_color">
							<div style="line-height: 22px;">
                                <a href="<?php echo base_url()?>" style="color: #8d94a3; text-decoration: none;">Kids Fun Parks</a>
							</div>
        				</td>
					</tr>
	                			...
	                			<tr>
	                				<td align="center">
	                					<table border="0" align="center" cellpadding="0" cellspacing="0">
	                						<tr>
												<td>
			        								<a style="display: block; width: 12px; height: 12px; border-style: none !important; border: 0 !important;" href="#"><img width="12" height="12" border="0" style="display: block; width: 12px; height: 12px;" src="http://themastermail.com/alerta/notif5/img/instagram.png" alt="instagram" /></a>		
			        							</td>
			        							<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			        							<td>
			        								<a style="display: block; width: 8px; height: 13px; border-style: none !important; border: 0 !important;" href="#"><img width="8" height="13" border="0" style="display: block; width: 8px; height: 13px;" src="http://themastermail.com/alerta/notif5/img/facebook.png" alt="facebook" /></a>			
			        							</td>
			        							<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			        							<td>
			        								<a style="display: block; width: 13px; height: 13px; border-style: none !important; border: 0 !important;" href="#"><img width="13" height="13" border="0" style="display: block; width: 13px; height: 13px;" src="http://themastermail.com/alerta/notif5/img/google.png" alt="google" /></a>		
			        							</td>
			        							<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			        							<td>
			        								<a style="display: block; width: 13px; height: 10px; border-style: none !important; border: 0 !important;" href="#"><img width="13" height="10" border="0" style="display: block; width: 13px; height: 10px;" src="http://themastermail.com/alerta/notif5/img/twitter.png" alt="twitter" /></a>		
			        							</td>
			        							<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
			        							<td>
			        								<a style="display: block; width: 12px; height: 12px; border-style: none !important; border: 0 !important;" href="#"><img width="12" height="12" border="0" style="display: block; width: 12px; height: 12px;" src="http://themastermail.com/alerta/notif5/img/linkeden.png" alt="linkden" /></a>		
			        							</td>
											</tr>		
	                					</table>				
	                				</td>
				...
				<table border="0" width="540" align="center" cellpadding="0" cellspacing="0" class="container580">
					<tr>
						<td align="center" style="color: #ffffff; font-size: 14px; font-family: 'Questrial', sans-serif; mso-line-height-rule: exactly; line-height: 30px;" class="text_color">
							<div style="line-height: 30px">
	        						© 2018 Kids Fun Parks. All Rights Reserved.
							</div>
        				</td>	
					</tr>
				</table>
