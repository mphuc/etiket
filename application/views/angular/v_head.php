...
<head>
    ...
    <title><?php echo ucfirst( $module );?></title>
    ...
    <link rel="stylesheet" href="<?php echo $asset; ?>css/custom.css" media="all">
    ...
    <script src="<?php echo base_url('themes/umbrella-back/2ndmaterial/angular/angular.min.js')?>"></script>
    ...
    <script type="text/javascript">
        var cms_module = '<?php echo $module;?>';
        var cms_url = '<?php echo base_url('cms/'.$module)?>';
    </script>
</head>

<body class="<?php if(isset($nastable)){}else{echo 'sidebar_main_open sidebar_main_swipe';} ?>" ng-app="<?php echo $module;?>">